...
import {
  ACCEL,
  ANTI_GRAV_IN_SURFACE_RE,
  ANTI_GRAV_OUT_SURFACE_RE,
  AUTO_STEP_HEIGHT_MAX,
  AUTO_STEP_HEIGHT_MIN,
  AUTO_STEP_HEIGHT_RATIO,
  AUTO_STEP_MIN_WIDTH_MIN,
  AUTO_STEP_MIN_WIDTH_RATIO,
  BOOSTER_RETRIGGER_COOLDOWN_MS,
  BOOSTER_SURFACE_RE,
  BOT_AUTO_BANANA_REAR_RANGE,
  BOT_AUTO_BLUE_SHELL_MIN_LEADER_DISTANCE,
  BOT_AUTO_BOOST_SPEED_RATIO,
  BOT_AUTO_BOMB_AHEAD_RANGE,
  BOT_AUTO_BOMB_REAR_RANGE,
  BOT_AUTO_BULLET_BILL_GAP_RANGE,
  BOT_AUTO_BULLET_BILL_MIN_POSITION,
  BOT_AUTO_GREEN_SHELL_RANGE,
  BOT_AUTO_ITEM_DECISION_MAX_DELAY_MS,
  BOT_AUTO_ITEM_DECISION_MIN_DELAY_MS,
  BOT_AUTO_ITEM_RECHECK_JITTER_MS,
  BOT_AUTO_ITEM_RECHECK_MS,
  BOT_AUTO_MUSHROOM_SPEED_RATIO,
  BOT_AUTO_RED_SHELL_RANGE,
  BOT_AUTO_STRAIGHT_STEER_THRESHOLD,
  BULLET_BILL_SPEED_MULTIPLIER,
  clamp,
  COAST,
  COLLIDER_COVERAGE_X,
  COLLIDER_COVERAGE_Y,
  COLLIDER_COVERAGE_Z,
  DEFAULT_BOOSTER,
  DEFAULT_CHARACTER_MOUNT,
  DEFAULT_KEY_BINDINGS,
  DEFAULT_OBJECT_ITEM_MAX_VALUE,
  DEFAULT_SURFACE_ATTACHMENT,
  ...
  FLAME_TRAIL_GRAVITY,
  FLAME_TRAIL_LATERAL_SPEED_JITTER,
  ...
  GROUND_RAY_START_MARGIN,
  GROUND_TILT_FACTOR,
  GRAVITY_ACCEL,
  LAKITU_BASE_SCALE,
  LAKITU_FADE_IN_SECONDS,
  LAKITU_FADE_OUT_SECONDS,
  LAKITU_FOLLOW_OFFSET_Y,
  LAKITU_POSITION_SMOOTHING,
  LAP_CHECKPOINT_SURFACE_RE,
  LAP_START_SURFACE_RE,
  LAP_TRIGGER_RETRIGGER_COOLDOWN_MS,
  LOOPING_DETACHED_REATTACH_DOT,
  LOOPING_DETACH_HOLD_MS,
  LOOPING_REFERENCE_WORLD_DOT,
  MAX_BACK,
  MAX_CLIMB_ANGLE_DEG,
  MAX_COIN_SPEED_MULTIPLIER,
  MAX_FWD,
  MAX_GROUND_RAY_RETRIES,
  MAX_YAW_RATE,
  MODEL_Y_OFFSET,
  OBJECT_10_BOMB_VALUE,
  OBJECT_11_BULLET_BILL_VALUE,
  OBJECT_13_COIN_VALUE,
  OBJECT_1_BOOST_DURATION_MS,
  OBJECT_1_BOOST_STRENGTH,
  OBJECT_2_BOOST_DURATION_MS,
  OBJECT_2_BOOST_STRENGTH,
  OBJECT_3_BANANA_VALUE,
  OBJECT_4_TRIPLE_BANANA_VALUE,
  OBJECT_5_GREEN_SHELL_VALUE,
  OBJECT_6_TRIPLE_GREEN_SHELL_VALUE,
  OBJECT_7_RED_SHELL_VALUE,
  OBJECT_8_TRIPLE_RED_SHELL_VALUE,
  OBJECT_9_BLUE_SHELL_VALUE,
  PLAYER_COIN_MAX,
  ROAD_RESCUE_DURATION_MS,
  ROAD_RESCUE_HOVER_PHASE,
  ROAD_RESCUE_LIFT_HEIGHT,
  ROAD_SURFACE_RE,
  ROTATION_SMOOTHING,
  SHOULD_LOG_GROUND_CONTACT,
  smoothstep01,
  SPAWN_CLEARANCE,
  START_BOOST_CHARGE_FROM_COUNTDOWN,
  START_BOOST_MAX_CHARGE_MS,
  START_BOOST_MAX_DURATION_MS,
  START_BOOST_MAX_STRENGTH,
  START_BOOST_MIN_DURATION_MS,
  START_BOOST_MIN_STRENGTH,
  START_BOOST_ORANGE_TRAIL_MIN_DURATION_MS,
  STEER_CHARGE_BIG_BOOST_DURATION_MS,
  STEER_CHARGE_BIG_BOOST_STRENGTH,
  STEER_CHARGE_BIG_THRESHOLD_MS,
  STEER_CHARGE_DOUBLE_TAP_WINDOW_MS,
  STEER_CHARGE_JUMP_SPEED,
  STEER_CHARGE_NORMAL_BOOST_DURATION_MS,
  STEER_CHARGE_NORMAL_BOOST_STRENGTH,
  STEER_CHARGE_NORMAL_THRESHOLD_MS,
  STEER_CHARGE_TURN_RATE_BONUS,
  STUN_SPIN_TOTAL_RAD,
  THUNDER_DEBUFF_SIZE_MULTIPLIER,
  THUNDER_DEBUFF_SPEED_MULTIPLIER,
  VEHICLE_COLLIDER_EXTRA_HEIGHT,
  VISUAL_STEP_MAX_LAG,
  VISUAL_STEP_SMOOTHING_DOWN,
  VISUAL_STEP_SMOOTHING_UP,
  WALL_COLLISION_ALIGN_DOT,
  WALL_GUARD_MAX_CLIMB_ANGLE_DEG,
  WALL_GUARD_SLIDE_MARGIN_DEG,
  WAYPOINT_RESCUE_HEIGHT_OFFSET,
  WAYPOINT_RESCUE_LOOKAHEAD,
  WAYPOINT_RESCUE_MAX_DISTANCE,
} from './drivable/drivableConstants';
import type {
  AttachmentSurfaceKind,
  FlameTrailColor,
  GroundHit,
  GroundHitOptions,
  Props,
